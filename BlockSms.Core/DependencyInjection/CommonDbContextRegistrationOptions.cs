...
namespace BlockSms.Core.DependencyInjection
{
    public abstract class CommonDbContextRegistrationOptions : ICommonDbContextRegistrationOptionsBuilder
    {
        ...
        private void AddCustomRepository(Type entityType, Type repositoryType)
        {
            ...
            {
                throw new EPTException($"Given repositoryType is not a repository: {entityType.AssemblyQualifiedName}. It must implement {typeof(IBasicRepository<>).AssemblyQualifiedName}.");
            }
